...
@WebMvcTest(controllers = AccountDetailsIdController.class)
class AccountDetailsIdControllerTest {
    ...
    @MockBean
    AccountDetailsIdServiceImp service;
    ...
    void test_read_Success() throws Exception {
        AccountDetailsIdDto expectedDto = getOldDto();
        ...
        this.mockMvc.perform(
                        get("/account/details/read/{id}", expectedDto.getId()))
    ...
    void test_create_Success() throws Exception {
        AccountDetailsIdDto expectedDto = getNewDto();
        String expectedJson = jsonMapper.writeValueAsString(expectedDto);
    ...
    void test_update_Success() throws Exception {
        ...
        this.mockMvc.perform(
                        put("/account/details/update/{id}", expectedDto.getId())
                                .content(expectedJson)
                                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().json(expectedJson));
    ...
    void test_update_EntityNotFound() throws Exception {
        ...
        this.mockMvc.perform(
                        put("/account/details/update/{id}", 0)
                                .content(expectedJson)
                                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().is(404));
    }
    ...
    void test_update_BadRequestMethod() throws Exception {
        ...
        this.mockMvc.perform(
                        post("/account/details/update/{id}", 0)
    ...
    void test_readAllById_Success() throws Exception {
        List<AccountDetailsIdDto> expectedDto = List.of(getOldDto(), getNewDto());
    ...
    private static AccountDetailsIdDto getOldDto() {
    ...
    private static AccountDetailsIdDto getNewDto() {
        return new AccountDetailsIdDto(
                1L,
                2L,
                getProfileDto()
